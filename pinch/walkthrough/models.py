    ...
    def statement(self):
        ...
        for redaction in redactions:
            if redaction.statement_start > last_redaction_end:
                minified_statement += [self.original_statement[last_redaction_end:redaction.statement_start]]
            last_redaction_end = redaction.statement_end
        minified_statement += minified_statement[last_redaction_end:len(self.original_statement)]
